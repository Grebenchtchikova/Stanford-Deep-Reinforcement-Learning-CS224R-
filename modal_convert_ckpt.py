...
/data/ckpts/gsm8k/<experiment_name>/ and writes the merged HF model to
/data/ckpts/gsm8k/<experiment_name>_hf/.
 
Usage:
    modal run modal_convert_ckpt.py --track a
    modal run modal_convert_ckpt.py --track b
    modal run modal_convert_ckpt.py --track a --step 400   # explicit step
"""
